...
$lang = array_merge($lang, [
	...
	'HELP_MARKDOWN_TEXT_STRIKETHROUGH_ANSWER' => 'Para tachar texto, enciérralo entre un par de <code>~~</code>, ej.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">~~Buenos días~~</code></pre> se convertirá<br><br><del>Buenos días</del>',
	'HELP_MARKDOWN_TEXT_SUBSCRIPT_QUESTION' => 'Creando subíndices',
	'HELP_MARKDOWN_TEXT_SUBSCRIPT_ANSWER' => 'Para crear subíndices, enciérralo entre un par de <code>~</code>, ej.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">H~2~O</code></pre> se convertirá<br><br>H<sub>2</sub>O',
	'HELP_MARKDOWN_TEXT_SUPERSCRIPT_QUESTION' => 'Creando superíndices',
	'HELP_MARKDOWN_TEXT_SUPERSCRIPT_ANSWER' => 'Para crear superíndices, agrega <code>^</code> antes del texto, ej.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">2^n</code></pre> se convertirá<br><br>2<sup>n</sup>',
	...
	'HELP_MARKDOWN_ORDERED_LIST_ANSWER' => 'Para crear una lista ordenada, agrega un dígito seguido por un punto y un espacio, ej.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">1. Elemento<br>    1. Subelemento<br>2. Elemento</code></pre> se convertirá<br><br><ol><li>Elemento <ol><li>Subelemento</li></ol></li><li>Elemento</li></ol>',

	'HELP_MARKDOWN_BLOCK_LINK' => 'Creando enlaces',
	'HELP_MARKDOWN_LINK_QUESTION' => 'Creando un enlace a otro sitio',
	'HELP_MARKDOWN_LINK_ANSWER' => 'Para crear enlaces, agrega el texto del enlace entre corchetes seguido por la URL del enlace entre paréntesis, ej.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">[Texto del enlace](http://example.org)</code></pre> se convertirá<br><br><a href="http://example.org">Texto del enlace</a>',

	'HELP_MARKDOWN_BLOCK_IMAGE' => 'Mostrando iḿagenes',
	'HELP_MARKDOWN_IMAGE_QUESTION' => 'Agregando imágenes',
	'HELP_MARKDOWN_IMAGE_ANSWER' => 'Para mostrar una imágen, agrega un signo de exclamación seguido por el texto alternativo de la imagen entre corchetes y luego la URL de la imagen entre paréntesis, ej.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">![phpBB](https://www.phpbb.com/assets/images/images/logos/blue/160x52.png)</code></pre> se convertirá<br><br><img src="https://www.phpbb.com/assets/images/images/logos/blue/160x52.png" alt="phpBB">',
	...
	'HELP_MARKDOWN_HORIZONTAL_RULE_ANSWER' => 'Para crear una regla horizontal, agrega al menos 3 <code>*</code>, <code>-</code> o <code>_</code> opcionalmente separados con un espacio, ej.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">***<br>* * *<br>---<br>- - -<br>___<br>_ _ _</code></pre> se convertirá<br><br><hr>'
]);
