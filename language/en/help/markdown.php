...
$lang = array_merge($lang, [
	...
	'HELP_MARKDOWN_QUOTE_ANSWER' => 'To quote text, add <code>&gt;</code> and optionally an space before the text line, e.g.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">&gt; Quoted text</code></pre> will become <blockquote class="uncited"><div><p>Quoted text</p></div></blockquote>',
	...
	'HELP_MARKDOWN_ORDERED_LIST_ANSWER' => 'To create an ordered list, add a digit followed by a dot and a space, e.g.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">1. Element<br>    1. Subelement<br>2. Element</code></pre> will become<br><br><ol><li>Element <ol><li>Subelement</li></ol></li><li>Element</li></ol>',
