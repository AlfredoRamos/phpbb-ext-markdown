...
$lang = array_merge($lang, [
	...
	'HELP_MARKDOWN_QUOTE_ANSWER' => 'To quote text, add <code>&gt;</code> and optionally an space before the text line, e.g.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">&gt; Quoted text</code></pre> will become <blockquote class="uncited"><div>Quoted text<p></p></div></blockquote>',
