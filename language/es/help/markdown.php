...
$lang = array_merge($lang, [
	...
	'HELP_MARKDOWN_QUOTE_ANSWER' => 'Para citar texto, agregue <code>&gt;</code> y opcionalmente un espacio antes de la línea de texto, ej.<pre class="markdown-demo"><code class="markdown" data-lang="markdown">&gt; Texto citado</code></pre> se convertirá <blockquote class="uncited"><div><p>Texto citado</p></div></blockquote>',
