...
$lang = array_merge($lang, [
	...
	'HELP_MARKDOWN_TEXT_STRIKETHROUGH_ANSWER' => 'Para tachar texto, enciérrelo entre un par de <code>~~</code>, ej.<pre class="markdown-code"><code class="markdown" data-lang="markdown">~~Buenos días~~</code></pre> se convertirá<br><br><del>Buenos días</del>',
	'HELP_MARKDOWN_TEXT_SUBSCRIPT_QUESTION' => 'Creando subíndices',
	'HELP_MARKDOWN_TEXT_SUBSCRIPT_ANSWER' => 'Para crear subíndices, enciérrelo entre un par de <code>~</code>, ej.<pre class="markdown-code"><code class="markdown" data-lang="markdown">H~2~O</code></pre> se convertirá<br><br>H<sub>2</sub>O',
	'HELP_MARKDOWN_TEXT_SUPERSCRIPT_QUESTION' => 'Creando superíndices',
	'HELP_MARKDOWN_TEXT_SUPERSCRIPT_ANSWER' => 'Para crear superíndices, agregue <code>^</code> antes del texto, ej.<pre class="markdown-code"><code class="markdown" data-lang="markdown">2^n</code></pre> se convertirá<br><br>2<sup>n</sup>',
	...
	'HELP_MARKDOWN_QUOTE_ANSWER' => 'Para citar texto, agregue <code>&gt;</code> y opcionalmente un espacio antes de la línea de texto, ej.<pre class="markdown-code"><code class="markdown" data-lang="markdown">&gt; Texto citado</code></pre> se convertirá <blockquote class="uncited"><div><p>Texto citado</p></div></blockquote>',
	'HELP_MARKDOWN_CODE_QUESTION' => 'Mostrando código',
	'HELP_MARKDOWN_CODE_ANSWER' => 'Para mostrar código, enciérrelo entre un par de <code>```</code> o <code>~~~</code>, o alternativamente agregue 4 espacios en blanco antes de cada línea. También puede especificar el lenguaje en el primer marcador, ej.<pre class="markdown-code"><code class="markdown" data-lang="markdown">```ruby<br>puts "Hola #{usuario}!"<br>```</code></pre> se convertirá <pre class="markdown-code"><code class="ruby" data-lang="ruby">puts "Hola #{usuario}!"</code></pre>',
